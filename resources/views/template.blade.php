    ...
    <div class="container-fluid p-0" style="">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="btn btn-outline-success mx-2" href="/register">Register</a>
        ...
        <footer class="py-3 text-center">
            <h1>Movie List</h1>
            <p>MovieList is a Website that contains list of movie</p>
            <div class="my-3">
            ...
            <p>Copyright @ 2021 MovieList All Rights Reserved</p>
        </footer>
    </div>
</body>
</html>
